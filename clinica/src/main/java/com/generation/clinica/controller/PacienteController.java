...
public class PacienteController {
 ...
 private PacienteRepository repository;
    ...
    //get
 	// pegando a paciente pelo Código
 	...
 	getByNome(@PathVariable long codPaciente){
 		return ResponseEntity.ok(repository.findAllBycodPacienteContainingIgnoreCase(codPaciente));
 	}
	//post
	@PostMapping
